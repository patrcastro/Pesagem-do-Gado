...
public class frmVisualizarGado extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    frmVisualizarGado frame = new frmVisualizarGado();
    ...
    public frmVisualizarGado() throws SQLException {
    ...
    private void adicionarColunasTabela() {
        String[] Colunas = new String[]{"Id", "RFID", "Raça", "Data de Nascimento", "Data de Aquisição", "Data de Saída"};
    ...
    private void ajustarTamanhosColunasTabela() {
        if (tbGado.getColumnModel().getColumnCount() > 0) {
            ...
            tbGado.getColumnModel().getColumn(1).setMaxWidth(110);
            tbGado.getColumnModel().getColumn(2).setMaxWidth(50);
            tbGado.getColumnModel().getColumn(3).setMaxWidth(150);
            tbGado.getColumnModel().getColumn(4).setMaxWidth(110);
            tbGado.getColumnModel().getColumn(5).setMaxWidth(110);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/VisualizarGado.png"))); // NOI18N
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        Gado.CarregarTabela(txtPesquisar.getText(), tabelaGeral);
